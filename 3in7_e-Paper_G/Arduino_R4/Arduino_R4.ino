...
void setup() {
    ...
    Paint_NewImage(BlackImage, EPD_3IN7G_WIDTH, EPD_3IN7G_HEIGHT/2, 0, EPD_3IN7G_WHITE);
    Paint_SetScale(4);
    ...
    printf("Paint_NewImage\r\n");
    Paint_NewImage(BlackImage, EPD_3IN7G_WIDTH/2, EPD_3IN7G_HEIGHT, 270, EPD_3IN7G_WHITE);
    Paint_SetScale(4);
    ...
    Paint_DrawString_CN(150, 20, "微雪电子", &Font24CN, EPD_3IN7G_RED, EPD_3IN7G_WHITE);
    Paint_DrawNum(10, 35, 123456, &Font12, EPD_3IN7G_RED, EPD_3IN7G_WHITE);

    printf("EPD_Display\r\n");
    EPD_3IN7G_Display_1(BlackImage);
    DEV_Delay_ms(3000);
#endif
